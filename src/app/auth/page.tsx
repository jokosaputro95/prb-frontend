          ...
          <div className="text-center mb-8">
            ...
            >
              ...
              <div className="absolute inset-1 bg-white dark:bg-gray-900 rounded-full flex items-center justify-center">
                <span className="text-3xl font-bold bg-gradient-to-r from-primary to-accent text-transparent bg-clip-text transition-colors">
                  PRB
                </span>
              </div>
            </motion.div>
              ...
              >
                <div
                  className="absolute inset-0 bg-gradient-to-r from-primary via-secondary to-accent 
                              animate-gradient-x group-hover:animate-gradient-x-fast"
                ></div>
                <div
                  className="relative bg-white dark:bg-gray-900 text-gray-900 dark:text-white 
